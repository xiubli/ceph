...
public:
  ...
  // -- requests --
  void set_reply_extra_bl(const cref_t<MClientRequest> &req, inodeno_t ino, bufferlist& extra_bl, bool check_async_dirop = false);
  ...
  CDir* try_get_complete_dirfrag(CInode *diri, frag_t fg, const MDRequestRef& mdr);
