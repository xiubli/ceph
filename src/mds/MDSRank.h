...
enum {
  ...
  l_mds_export_authpin_fail,
  l_mds_export_trylock_fail,
  l_mds_export_freeze_fail,
  l_mds_export_discover_fail,
  l_mds_export_prep_fail,
  l_mds_export_peer_fail,
  l_mds_imported,
  l_mds_imported_inodes,
  l_mds_import_fail,
  l_mds_import_peer_cancel,
  l_mds_import_trylock_fail,
  l_mds_import_peer_fail,
  l_mds_import_resolve_fail,
  l_mds_export_fail,
