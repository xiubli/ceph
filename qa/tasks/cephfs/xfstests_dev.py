...
class XFSTestsDev(CephFSTestCase):
    ...
    def get_repos(self):
        ...
        self.xfstests_repo_path = self.mount_a.client_remote.mkdtemp(suffix=
                                                            'xfstests-dev')
        # Make the xfstests_repo_path to be readable and excutable for
        # other users, this will allow the xfstests to run the user namespace
        # test cases, such as the generic/317.
        ...
        if self.install_xfsprogs:
            ...
            self.xfsprogs_repo_path = self.mount_a.client_remote.mkdtemp(suffix=
                                                                'xfsprogs-dev')
            # Make the xfsprogs_repo_path to be readable and excutable for
            # other users, this will allow the xfstests to run the user namespace
            # test cases.
